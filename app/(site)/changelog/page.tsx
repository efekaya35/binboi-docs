    ...
    <div className="space-y-14">
      ...
      <RevealGroup className="space-y-6" stagger={0.1}>
        {CHANGELOG_ENTRIES.map((entry) => (
          <Panel
            key={entry.version}
            className="relative overflow-hidden rounded-[32px] border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.015))] p-0"
          >
            <div className="absolute left-0 top-0 h-full w-px bg-gradient-to-b from-transparent via-primary/35 to-transparent" />
